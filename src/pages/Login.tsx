...
const RealisticIPodLogin = () => {
  ...
  const playStartupSound = () => {
    // Usando uma URL de dados para evitar requisições externas
    const audioData = "data:audio/mpeg;base64,SUQzBAAAAAAAI1RTU0UAAAAPAAAAAAA/A2F1ZGlvL21wZWctbWFjaGluZSBMQzE1NzcwMCBqLmpmaGw3cDFkYWFsL1Vhb2ZtT2h4U1EwMC91bzFnbWV0aGFsYS8waFh6L0lwdXU3Xy8xYy8xcGEvNGMvOWYvOGg1ai8xaS94X3g3cy92X1ovdW9pL1V1dGVzdGVzL3Rlc3QvMDFvX3NvbGlkLwA=";
    if (audioRef.current) {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      ...
      setIsPoweredOn(true);
      playStartupSound();
    }, 1500); // Duração da animação de ligar
  }, []);
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      if (data.user) {
        ...
        const loginMessage = document.getElementById('loginMessage') as HTMLElement;
        if (loginMessage) {
          loginMessage.innerText = "Login realizado com sucesso! Bem-vindo à Conexão UNK.";
          loginMessage.style.color = "#10b981"; // Verde para sucesso
          loginMessage.style.opacity = "1";
          setTimeout(() => {
            loginMessage.style.opacity = "0";
      ...
      const loginMessage = document.getElementById('loginMessage') as HTMLElement;
      if (loginMessage) {
        loginMessage.innerText = error.message || "Erro ao fazer login. Verifique suas credenciais.";
        loginMessage.style.color = "#ef4444"; // Vermelho para erro
        loginMessage.style.opacity = "1";
        setTimeout(() => {
          loginMessage.style.opacity = "0";
        }, 3000);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-100 to-gray-300 flex items-center justify-center p-4 sm:p-8 font-inter">
      ...
      <div className="relative">
        ...
        <div className="w-80 h-[650px] bg-gradient-to-b from-white via-gray-50 to-gray-100 rounded-[60px] border border-gray-200 relative overflow-hidden"
          style={{
            boxShadow: `
          ...
          <div className="relative mx-6 mt-6 mb-8">
            <div className="h-72 bg-gradient-to-b from-gray-900 to-black rounded-lg relative overflow-hidden border border-gray-800"
              style={{
                boxShadow: `
              ...
              <div className={`absolute inset-0 flex items-center justify-center transition-opacity duration-1000 ${isAnimating ? 'opacity-100' : 'opacity-0'}`}>
                <div className="relative w-24 h-24">
                  ...
                  <div className="w-full h-full flex items-center justify-center">
                    <img src="https://placehold.co/48x48/black/white?text=" alt="Apple logo" className="w-12 h-12" />
                  </div>
                </div>
              </div>
              ...
              <div className={`relative z-10 p-6 h-full flex flex-col transition-opacity duration-1000 ${isPoweredOn ? 'opacity-100' : 'opacity-0'}`}>
                ...
                <div className="text-center mb-4">
                  ...
                  <p className="text-xs text-gray-400">Fuderosa Systems</p>
                </div>
                ...
                {/* Mensagem de status */}
                <div id="loginMessage" className="absolute bottom-4 left-1/2 -translate-x-1/2 w-4/5 text-center text-xs opacity-0 transition-opacity duration-300"></div>
          ...
          <div className="relative mx-auto">
            <div className="w-52 h-52 rounded-full mx-auto relative bg-gradient-to-b from-gray-100 via-white to-gray-200 border border-gray-300"
              style={{
                boxShadow: `
              ...
              <div className="absolute inset-2 rounded-full border border-gray-400/30"
                style={{
                  boxShadow: `
                    inset 0 1px 2px rgba(0,0,0,0.1),
                    inset 0 -1px 0 rgba(255,255,255,0.8)
          ...
          <div className="text-center mt-6 pb-6">
            <div className="text-xs text-gray-500 space-y-0.5">
              <p className="font-medium">Fuderosa Systems</p>
              <p>Music Manager Pro</p>
              <p className="text-gray-400">Version 1.0.0</p>
            </div>
          </div>

          {/* Chave de bloqueio */}
          <div className="absolute top-16 -right-1 w-6 h-12 bg-gradient-to-r from-gray-300 to-gray-400 rounded-r-lg border-r border-gray-500"
            style={{
              boxShadow: `
            ...
            <div className="w-4 h-6 bg-gradient-to-r from-gray-400 to-gray-500 rounded-r mt-3 ml-1"
              style={{
                boxShadow: `
      ...
      {/* Elemento de áudio para o som de inicialização */}
      <audio ref={audioRef} preload="auto">
        <source src="data:audio/mpeg;base64,SUQzBAAAAAAAI1RTU0UAAAAPAAAAAAA/A2F1ZGlvL21wZWctbWFjaGluZSBMQzE1NzcwMCBqLmpmaGw3cDFkYWFsL1Vhb2ZtT2h4U1EwMC91bzFnbWV0aGFsYS8waFh6L0lwdXU3Xy8xYy8xcGEvNGMvOWYvOGg1ai8xaS94X3g3cy92X1ovdW9pL1V1dGVzdGVzL3Rlc3QvMDFvX3NvbGlkLwA=" type="audio/mpeg" />
      </audio>
    </div>
  );
};

export default RealisticIPodLogin;
