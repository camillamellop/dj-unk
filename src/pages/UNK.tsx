...
export default function UNK() {
  ...
  const logoSrc = '/logo.png'; // coloque seu logo em public/
            ...
            >
              ...
              <div className="relative z-10 flex flex-col items-center">
                <div className="w-32 h-32 bg-black rounded-full flex items-center justify-center border-4 border-white/20 shadow-2xl mb-4">
                  <img src={logoSrc} alt="UNK Logo" width={80} height={80} className="object-contain" />
                </div>
                <h2 className="text-2xl font-light text-gray-200 tracking-wider mb-2">Assessoria</h2>
                ...
                <p className="relative z-10 text-gray-300 text-base leading-relaxed mt-2 px-2">
                  A Conexão UNK é um núcleo de desenvolvimento artístico real, criado por quem vive a música de verdade e conhece o peso que ela pode carregar.<br/>
                  Aqui, o artista não é só mais um perfil na vitrine. A gente olha pra a pessoa por trás do projeto. Essa é a raiz da Conexão UNK.<br/>
          ...
          >
            <div className="relative h-full flex flex-col p-6">
              <div className="text-center mb-6">
                <h2 className="text-2xl font-bold text-white mb-2">Termos do Contrato</h2>
              ...
              <div className="flex-1 overflow-y-auto pr-2 space-y-4 text-left">
                <div className="bg-black/30 rounded-xl p-3 border border-white/10">
                  <p className="text-gray-300 text-sm">Conteúdo a definir.</p>
                </div>
                <div className="bg-black/30 rounded-xl p-3 border border-white/10">
                  <p className="text-gray-300 text-sm">Políticas a definir.</p>
                </div>
              </div>
            </div>
          </div>
